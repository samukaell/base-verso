...
const regexBody = /(<div className="p-5 flex-1 overflow-y-auto space-y-6">)([\s\S]*?)(<div className="p-4 border-t border-slate-700\/50 bg-slate-800\/80 flex flex-col gap-2">)/;

if (!regexBody.test(c)) {
  console.log("Could not match regexBody!");
  process.exit(1);
}
...
console.log("Successfully injected Ficha details.");
